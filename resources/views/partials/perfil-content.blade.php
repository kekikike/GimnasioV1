            ...
            <div v-show="tabActiva==='usuario'">
                <div class="grid-2">
                    ...
                    <div class="field-group">
                        ...
                        <input type="text" v-model="formulario.contrasena_confirmation" class="form-control password-mask" :disabled="!editando" :required="formulario.contrasena!==''" placeholder="Repite la contrasena" :class="[{'is-invalid': errores.contrasena}]" autocomplete="off" :readonly="!editando || passConfirmReadonly" @focus="if(!editando) return; passConfirmReadonly = false">
...
createApp({
    setup() {
        ...
        return { formulario, errores, editando, guardando, tabActiva, mostrarPassword, passReadonly, passConfirmReadonly, toggleEditar, validarLetras, filtrarTelefono, limpiarError, guardarPerfil };
    }
}).mount('#appPerfil');
</script>
