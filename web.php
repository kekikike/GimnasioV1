...
Route::prefix('reportes')->group(function () {
    ...
    Route::get('/socios', [App\Http\Controllers\ReporteController::class, 'socios'])->name('reportes.socios');
    Route::get('/financiero', [App\Http\Controllers\ReporteController::class, 'financiero'])->name('reportes.financiero');
    Route::get('/asistencia', [App\Http\Controllers\ReporteController::class, 'asistencia'])->name('reportes.asistencia');
    Route::get('/clases', [App\Http\Controllers\ReporteController::class, 'clases'])->name('reportes.clases');
    Route::get('/equipamiento', [App\Http\Controllers\ReporteController::class, 'equipamiento'])->name('reportes.equipamiento');
});
