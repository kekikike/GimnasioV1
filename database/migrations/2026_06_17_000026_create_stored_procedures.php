...
return new class extends Migration
{
    ...
    public function __construct()
    {
        $this->tables = [
            ...
            'TNotificaciones' => ['pk' => 'idNotificacion', 'cols' => ['idUsuario', 'tipoNotificacion', 'mensaje', 'fechaEnvio', 'estado'], 'auditCols' => ['idUsuario', 'tipoNotificacion', 'mensaje', 'fechaEnvio', 'estado'], 'autoinc' => true],
