...
return new class extends Migration
{
    ...
    {
        // 1. Eliminar columna cuposOcupados (se calculará dinámicamente)
        ...
        // 2. Recrear sp_TReservas_Cancelar_Validated (sin cupo management)
...
END
        ...
        // 3. Recrear sp_TReservas_MarcarAsistencia_Entrenador (sin cupo management)
...
END
        ...
        // 4. Recrear sp_TReservas_MarcarAsistencia_Integrado (sin cupo management)
...
END
    ...
    public function down(): void
    {
        ...
        // Restaurar versión original de sp_TReservas_Cancelar_Validated (con cupo)
        $pdo->exec("DROP PROCEDURE IF EXISTS sp_TReservas_Cancelar_Validated");
        $pdo->exec("
CREATE PROCEDURE sp_TReservas_Cancelar_Validated(
    IN p_idReserva INT,
...
END
        ...
        // Restaurar versión original de sp_TReservas_MarcarAsistencia_Entrenador (con cupo)
        $pdo->exec("DROP PROCEDURE IF EXISTS sp_TReservas_MarcarAsistencia_Entrenador");
        $pdo->exec("
CREATE PROCEDURE sp_TReservas_MarcarAsistencia_Entrenador(
    IN p_idReserva INT,
...
END
        ...
        // Restaurar versión original de sp_TReservas_MarcarAsistencia_Integrado (con cupo)
        $pdo->exec("DROP PROCEDURE IF EXISTS sp_TReservas_MarcarAsistencia_Integrado");
        $pdo->exec("
CREATE PROCEDURE sp_TReservas_MarcarAsistencia_Integrado(
    IN p_idReserva INT,
